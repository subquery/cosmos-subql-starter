...
exports.loadChainTypesFromJs = exports.parseChainTypes = exports.loadAvalancheProjectManifest = exports.loadChainTypes = exports.parseAvalancheProjectManifest = void 0;
...
function parseAvalancheProjectManifest(raw) {
    const projectManifest = new versioned_1.AvalancheProjectManifestVersioned(raw);
    projectManifest.validate();
    return projectManifest;
}
exports.parseAvalancheProjectManifest = parseAvalancheProjectManifest;
...
function loadAvalancheProjectManifest(file) {
    ...
    const projectManifest = new versioned_1.AvalancheProjectManifestVersioned(doc);
    projectManifest.validate();
    return projectManifest;
}
exports.loadAvalancheProjectManifest = loadAvalancheProjectManifest;
