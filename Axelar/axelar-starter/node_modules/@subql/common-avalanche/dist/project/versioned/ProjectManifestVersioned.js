...
exports.AvalancheProjectManifestVersioned = exports.manifestIsV1_0_0 = exports.manifestIsV0_3_0 = void 0;
const class_transformer_1 = require("class-transformer");
const v0_3_0_1 = require("./v0_3_0");
const v1_0_0_1 = require("./v1_0_0");
const AVALANCHE_SUPPORTED_VERSIONS = {
...
class AvalancheProjectManifestVersioned {
    constructor(projectManifest) {
        const klass = AVALANCHE_SUPPORTED_VERSIONS[projectManifest.specVersion];
        if (!klass) {
...
exports.AvalancheProjectManifestVersioned = AvalancheProjectManifestVersioned;
