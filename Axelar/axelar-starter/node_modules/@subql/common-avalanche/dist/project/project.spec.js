...
describe.skip('project.yaml', () => {
    it('can validate project.yaml', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_falsy.yaml'))).toThrow();
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_falsy_array.yaml'))).toThrow();
    });
    it('can fail validation if version not supported', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_invalid_version.yaml'))).toThrow();
    });
    it('can validate a v0.2.0 project.yaml with a custom data source', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_0.2.0_custom_ds.yaml'))).not.toThrow();
    });
    it('can validate a v0.2.1 project.yaml with templates', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_0.2.1.yaml'))).not.toThrow();
    });
    it('can validate a v1.0.0 project.yaml with templates', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_1.0.0.yaml'))).not.toThrow();
    });
    it('get v1.0.0 deployment mapping filter', () => {
        const manifestVersioned = (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_1.0.0.yaml'));
    ...
    it('can convert genesis hash in v1.0.0 to chainId in deployment', () => {
        const deployment = (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_1.0.0.yaml')).asV1_0_0.deployment;
    ...
    it.skip('can get chainId for deployment', () => {
        const deployment = (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_1.0.0_chainId.yaml')).asV1_0_0
            .deployment;
    ...
    it('can validate deployment runner versions', () => {
        ...
        const nodeImp = new v1_0_0_1.AvalancheRunnerNodeImpl();
        const queryImp = new common_1.RunnerQueryBaseModel();
        deployment.specVersion = '1.0.0';
        deployment.runner = new v1_0_0_1.AvalancheRunnerSpecsImpl();
    ...
    it('can validate a v1.0.0 project.yaml with unsupported runner node', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_1.0.0_bad_runner.yaml'))).toThrow();
    });
    //TODO, pre-release should be excluded
    it.skip('can throw error with unsupported runner version', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_1.0.0_bad_runner_version.yaml'))).toThrow();
    });
    it('can validate a v1.0.0 project.yaml runner and datasource mismatches', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_1.0.0_runner_ds_mismatch.yaml'))).toThrow();
    });
    it('can fail validation if custom ds missing processor', () => {
        expect(() => (0, load_1.loadAvalancheProjectManifest)(path_1.default.join(projectsDir, 'project_0.2.0_invalid_custom_ds.yaml'))).toThrow();
    });
});
