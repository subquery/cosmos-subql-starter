import { AvalancheBlock, AvalancheBlockWrapper, AvalancheTransactionFilter, AvalancheLog, AvalancheLogFilter, AvalancheTransaction } from './avalanche';
...
export interface BlockWrapper<B extends AvalancheBlock = AvalancheBlock, C extends AvalancheTransaction = AvalancheTransaction, E extends AvalancheLog = AvalancheLog, CF extends AvalancheTransactionFilter = AvalancheTransactionFilter, EF extends AvalancheLogFilter = AvalancheLogFilter> {
    block: B;
    blockHeight: number;
    specVersion?: number;
    hash: string;
