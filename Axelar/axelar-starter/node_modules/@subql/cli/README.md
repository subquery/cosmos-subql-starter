...
@subql/cli/1.10.0 linux-x64 node-v16.18.1
$ subql --help [COMMAND]
USAGE
  $ subql COMMAND
...
...
_See code: [lib/commands/build.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/build.js)_
...
_See code: [lib/commands/codegen.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/codegen.js)_
...
_See code: [lib/commands/deployment/index.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/deployment/index.js)_
...
_See code: [lib/commands/deployment/delete.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/deployment/delete.js)_
...
_See code: [lib/commands/deployment/deploy.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/deployment/deploy.js)_
...
_See code: [lib/commands/deployment/promote.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/deployment/promote.js)_
...
_See code: [lib/commands/init.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/init.js)_
...
_See code: [lib/commands/migrate.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/migrate.js)_
...
_See code: [lib/commands/project/index.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/project/index.js)_
...
_See code: [lib/commands/project/create-project.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/project/create-project.js)_
...
_See code: [lib/commands/project/delete-project.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/project/delete-project.js)_
...
_See code: [lib/commands/publish.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/publish.js)_
...
OPTIONS
  ...
  --ipfs=ipfs                                                                  [default: https://unauthipfs.subquery.net
                                                                               work/ipfs/api/v0] IPFS gateway endpoint,
                                                                               used for validating projects on IPFS

  --network-family=(Substrate|Avalanche|Terra|Cosmos|Algorand|Ethereum|Flare)

  --silent
```

_See code: [lib/commands/validate.js](https://github.com/packages/cli/blob/v1.10.0/lib/commands/validate.js)_
<!-- commandsstop -->
