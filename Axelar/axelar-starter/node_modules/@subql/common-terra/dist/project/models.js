...
exports.TerraCustomDataSourceBase = exports.TerraFileReferenceImpl = exports.TerraRuntimeDataSourceBase = exports.TerraCustomMapping = exports.TerraMapping = exports.TerraCustomHandler = exports.TerraEventHandler = exports.TerraMessageHandler = exports.TerraTransactionHandler = exports.TerraBlockHandler = exports.TerraEventFilter = exports.TerraMessageFilter = void 0;
const types_terra_1 = require("@subql/types-terra");
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
class TerraMessageFilter {
}
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], TerraMessageFilter.prototype, "type", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsObject)(),
    __metadata("design:type", Object)
], TerraMessageFilter.prototype, "values", void 0);
__decorate([
    (0, class_validator_1.ValidateIf)((o) => o.type === '/terra.wasm.v1beta1.MsgExecuteContract'),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], TerraMessageFilter.prototype, "contractCall", void 0);
exports.TerraMessageFilter = TerraMessageFilter;
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => TerraMessageFilter),
    __metadata("design:type", Object)
], TerraEventFilter.prototype, "messageFilter", void 0);
...
class TerraTransactionHandler {
}
__decorate([
    (0, class_validator_1.IsEnum)(types_terra_1.SubqlTerraHandlerKind, { groups: [types_terra_1.SubqlTerraHandlerKind.Transaction] }),
    __metadata("design:type", String)
], TerraTransactionHandler.prototype, "kind", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], TerraTransactionHandler.prototype, "handler", void 0);
exports.TerraTransactionHandler = TerraTransactionHandler;
class TerraMessageHandler {
}
__decorate([
    (0, class_validator_1.IsEnum)(types_terra_1.SubqlTerraHandlerKind, { groups: [types_terra_1.SubqlTerraHandlerKind.Message] }),
    __metadata("design:type", String)
], TerraMessageHandler.prototype, "kind", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], TerraMessageHandler.prototype, "handler", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => TerraMessageFilter),
    __metadata("design:type", TerraMessageFilter)
], TerraMessageHandler.prototype, "filter", void 0);
exports.TerraMessageHandler = TerraMessageHandler;
    ...
    (0, class_transformer_1.Transform)((params) => {
        ...
        return handlers.map((handler) => {
            switch (handler.kind) {
                ...
                case types_terra_1.SubqlTerraHandlerKind.Message:
                    return (0, class_transformer_1.plainToClass)(TerraMessageHandler, handler);
                case types_terra_1.SubqlTerraHandlerKind.Transaction:
                    return (0, class_transformer_1.plainToClass)(TerraTransactionHandler, handler);
