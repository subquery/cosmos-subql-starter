# SubQuery - Starter Package for Cosmos Archway

A basic Cosmos (based on Archway) example project with an event and message handler. Read more about SubQuery support for Cosmos at https://academy.subquery.network/quickstart/quickstart_chains/cosmos.html.
...
This Starter Package by default allows **indexing all [Archway contract metadata](https://docs.archway.io/developers/rewards/managing-rewards#contract-metadata)**.
