# SubQuery - Starter Package for Cosmos Neutron

A basic Cosmos (based on Neutron) example project with an event and message handler. Read more about SubQuery support for Cosmos at https://academy.subquery.network/quickstart/quickstart_chains/cosmos.html.
...
This Starter Package by default allows **indexing all [Neutron airdrop ](https://docs.archway.io/developers/rewards/managing-rewards#contract-metadata)**.
