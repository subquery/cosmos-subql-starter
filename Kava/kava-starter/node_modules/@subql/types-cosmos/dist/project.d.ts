...
export type SubqlCosmosRuntimeHandler = SubqlCosmosBlockHandler | SubqlCosmosTransactionHandler | SubqlCosmosMessageHandler | SubqlCosmosEventHandler;
...
export type SecondLayerHandlerProcessor<K extends SubqlCosmosHandlerKind, F, E, DS extends SubqlCosmosCustomDatasource = SubqlCosmosCustomDatasource> = SecondLayerHandlerProcessor_0_0_0<K, F, E, DS> | SecondLayerHandlerProcessor_1_0_0<K, F, E, DS>;
export {};
