...
declare type TerraRuntimeFilterMap = {
...
export declare type SubqlTerraHandlerFilter = SubqlTerraEventFilter | SubqlTerraMessageFilter;
...
export declare type SubqlTerraRuntimeHandler = SubqlTerraBlockHandler | SubqlTerraTransactionHandler | SubqlTerraMessageHandler | SubqlTerraEventHandler;
export declare type SubqlTerraHandler = SubqlTerraRuntimeHandler | SubqlTerraCustomHandler;
...
export interface SubqlTerraRuntimeDatasource<M extends SubqlTerraMapping<SubqlTerraRuntimeHandler> = SubqlTerraMapping<SubqlTerraRuntimeHandler>> extends ISubqlTerraDatasource<M> {
    kind: SubqlTerraDatasourceKind.Runtime;
}
export declare type SubqlTerraDatasource = SubqlTerraRuntimeDatasource | SubqlTerraCustomDatasource;
export declare type CustomTerraDataSourceAsset = FileReference;
export interface SubqlTerraCustomDatasource<K extends string = string, M extends SubqlTerraMapping = SubqlTerraMapping<SubqlTerraCustomHandler>, O = any> extends ISubqlTerraDatasource<M> {
    kind: K;
    assets: Map<string, CustomTerraDataSourceAsset>;
    processor?: Processor<O>;
}
export interface TerraHandlerInputTransformer<T extends SubqlTerraHandlerKind, U, DS extends SubqlTerraCustomDatasource = SubqlTerraCustomDatasource> {
    (original: TerraRuntimeHandlerInputMap[T], ds: DS, api: LCDClient, assets: Record<string, string>): Promise<U>;
}
export interface SubqlTerraDatasourceProcessor<K extends string, DS extends SubqlTerraCustomDatasource<K> = SubqlTerraCustomDatasource<K>> {
    kind: K;
...
export interface SecondLayerTerraHandlerProcessor<K extends SubqlTerraHandlerKind, F, E, DS extends SubqlTerraCustomDatasource = SubqlTerraCustomDatasource> {
    baseHandlerKind: K;
