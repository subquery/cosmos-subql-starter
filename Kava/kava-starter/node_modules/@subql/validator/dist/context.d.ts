...
export interface ContextData {
    projectPath: string;
    pkg: IPackageJson;
    schema?: SubstrateProjectManifestVersioned | TerraProjectManifestVersioned | CosmosProjectManifestVersioned | AvalancheProjectManifestVersioned | AlgorandProjectManifestVersioned | EthereumProjectManifestVersioned | FlareProjectManifestVersioned | NearProjectManifestVersioned;
}
