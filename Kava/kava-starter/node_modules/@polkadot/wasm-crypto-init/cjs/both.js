...
const wasm_crypto_asmjs_1 = require("@polkadot/wasm-crypto-asmjs");
 ...
 */
exports.createWasm = (0, wasm_bridge_1.createWasmFn)('crypto', wasm_crypto_wasm_1.wasmBytes, wasm_crypto_asmjs_1.asmJsInit);