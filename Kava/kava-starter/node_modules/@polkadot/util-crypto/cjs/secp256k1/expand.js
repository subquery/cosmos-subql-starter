...
function secp256k1Expand(publicKey, onlyJs) {
    ...
    const { x, y } = secp256k1_1.Point.fromHex(publicKey);
    return (0, util_1.u8aConcat)((0, util_1.bnToU8a)(x, bn_js_1.BN_BE_256_OPTS), (0, util_1.bnToU8a)(y, bn_js_1.BN_BE_256_OPTS));
}
